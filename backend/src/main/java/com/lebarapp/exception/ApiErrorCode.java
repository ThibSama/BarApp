...
public enum ApiErrorCode {
    ...
    COCKTAIL_ALREADY_EXISTS(HttpStatus.CONFLICT,
            "Un cocktail portant ce nom existe déjà dans cette catégorie."),
    CATEGORY_INACTIVE(HttpStatus.CONFLICT,
            "Impossible de rattacher un cocktail à une catégorie inactive."),
