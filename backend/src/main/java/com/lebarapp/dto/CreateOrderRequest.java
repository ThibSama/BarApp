 ...
 * physical {@code tableNumber} (1..25) and the selected {@code paymentMethod},
...
public record CreateOrderRequest(
        ...
        @Min(value = 1, message = "Le numéro de table doit être compris entre 1 et 25.")
        @Max(value = 25, message = "Le numéro de table doit être compris entre 1 et 25.")
        Integer tableNumber,
